 ...
 *
 * Common controls shared by every MeshToonMaterial panel.
 *
 * Ported from the reference `ToonMaterialCommonPanel` class.
 */
 ...
 */
export function toonMaterialCommonPanelItems(mesh) {
