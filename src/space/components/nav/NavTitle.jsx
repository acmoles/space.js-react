...
/**
 * Left-floating nav title with optional name, caption and click/link behaviour.
 * Used as the left-side label inside a `Header` or `Footer`. Its `animateIn` and
 * `animateOut` are driven by the parent composite.
 *
 * @param {object} props
 ...
 * @example
 * <NavTitle name="Space.js" caption="Examples" link="https://ufo.ai/" />
 */
